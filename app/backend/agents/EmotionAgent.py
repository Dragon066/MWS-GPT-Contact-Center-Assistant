...
class EmotionAgent(BaseAgent):
    EMOTIONS = ["нейтральное", "гнев", "радость", "грусть"]
    ...
    def __new__(cls, verbose: bool = False) -> Runnable:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "Ты — классификатор эмоций. Анализируй текст или сообщения из чата ПОЛЬЗОВАТЕЛЯ (user/human) и определяй ДОМИНИРУЮЩУЮ эмоцию.",
                ),
